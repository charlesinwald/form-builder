...
const TransformerCheckbox = React.forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement>>(
  ({ className, disabled, ...props }, ref) => {
    return (
      <label className={cn(
        "relative block h-[1.5rem] w-[1.5rem] rounded-sm outline-2 outline-offset-1 outline-gray-700 has-[:focus-visible]:outline",
        ...
        />
        <span className={cn(
          "block h-[inherit] w-[inherit] rounded-md border-[2px] transition-all duration-300",
